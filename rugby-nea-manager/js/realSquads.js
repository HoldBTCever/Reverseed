...
const CURDA_ROSTER = [
  ...
  mkPlayer('Carlos Rodríguez', 'PI', 68, {}, {nickname: 'Salta'}),
  ...
  mkPlayer('Javier Pérez', 'SL', 85, {}, {nickname: 'Javo', nationalTeam: 'seleção do Paraguai adulta'}),
  mkPlayer('Carlos Plate', 'SL', 85, {}, {nickname: 'Charlie', nationalTeam: 'seleção do Paraguai adulta'}),
