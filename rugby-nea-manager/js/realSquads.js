...
const CURDA_ROSTER_RAW = [
  ...
  mkPlayer('Joaquín Alzueta', 'AL', 68, {}, {nickname: 'Joaco', age: 20, note: 'joga também de centro ou octavo', altPos: ['CE', 'N8']}, 59),
  ...
  {...mkPlayer('Luciano Nissel', 'AL', 68, {}, {nickname: 'Chile', note: 'joga também de octavo', altPos: ['N8']}, 59), heightCm: 177, weightKg: 105},
  ...
  mkPlayer('Piero Fiorio', 'CE', 66, {speed: 88, strength: 85}, {note: 'centro rápido e bem forte'}, 62),
